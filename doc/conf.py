# -*- coding: utf-8 -*-
#
# pyprox documentation build configuration file, created by
...
project = u'pyprox'
copyright = u'2012, Samuel Vaiter'
...
exclude_patterns = ['_build', '_templates', '_includes']
...
latex_documents = [
  ('index', 'pyprox.tex', u'pyprox Documentation',
...
man_pages = [
    ('index', 'pyprox', u'pyprox Documentation',
     [u'Samuel Vaiter'], 1)
]
...
texinfo_documents = [
  ('index', 'pyprox', u'pyprox Documentation',
   u'Samuel Vaiter', 'pyprox', 'One line description of project.',
   'Miscellaneous'),
]
